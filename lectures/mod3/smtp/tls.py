...
# raise an error for any of the following conditions
# 1. There is no support for TLS on the remote side.
# 2. The remote side fails to establish a TLS session properly.
# 3. The remote server presents a certificate that cannot be validated.
