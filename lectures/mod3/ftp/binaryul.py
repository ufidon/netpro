...
def main():
    ...
    with open(localfile, 'rb') as f:
        '''
        storbinary() calls the read() method repeatedly on the object 
        until its content is exhausted. used for binary files
        storlines() calls the readline() method, used for text files
        ''' 
