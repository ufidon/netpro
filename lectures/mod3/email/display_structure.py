...
# uses a recursive generator to visit every part of a multipart message. 
# The generator’s operation is similar to that of 
# the build-in [walk() method](https://docs.python.org/3/library/email.message.html), 
# except that this generator keeps up with the index of each
